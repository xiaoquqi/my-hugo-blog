...
{{< figure src="/images/ai-era-team-collaboration/experiment-comparison.svg" alt="对比实验：传统团队协作 vs 一人×AI" caption="同一产品，两种研发组织方式——结果出乎所有人的意料" >}}
...
{{< figure src="/images/ai-era-team-collaboration/task-split-evolution.svg" alt="任务拆分标准的演变：从功能边界到认知沟通成本" caption="AI 改变了分工的底层逻辑——执行成本下降后，理解成本成为真正的瓶颈" >}}
...
{{< figure src="/images/ai-era-team-collaboration/ai-8020-rule.svg" alt="AI 时代的 80/20 法则：前80%执行，后20%判断" caption="AI 大幅加速了前 80%，但决定产品质量的后 20% 仍然依赖判断力与品味" >}}
