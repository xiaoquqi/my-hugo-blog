---
title: 5 美元，换回一个人一周：我们如何用 AI 沉淀企业碎片化知识
...
tags:
  ...
  - 开源
draft: false
slides: "/slides/why-we-built-ai-my-chats/"
---

**5 美元**，换回一个人一周的工作时间——从去年 8 月到今年 7 月，我们的云迁移和云灾备产品研发团队用 AI-My-Chats 每月处理 100 多条碎片化知识，模型成本平均约 **5 美元**，切换到开源模型后最近更降至约 **3.1 美元**，而这篇文章讲的，就是这组数字背后的实践与思考。

{{< figure src="/images/why-we-built-ai-my-chats/azure-cost-overview.webp" alt="Azure 月度成本总览：2025 年 8 月至 2026 年 7 月按月拆分，总计 70.54 美元，按服务名称、地域、订阅拆分" caption="真实账单：近一年按月拆分，模型成本平均每月约 $5" >}}
...
目前，我们主要使用 DeepSeek V4 Pro 处理文本理解与总结，使用千问 3.6 Plus 处理图片和上下文。这只是我们当前使用的模型组合，并不是产品的固定限制。
...
因此，目前我们主要使用 DeepSeek V4 Pro 处理文本理解与总结，使用千问 3.6 Plus 处理图片和上下文。切到这套开源组合后，我们的平均月成本从约 5 美元进一步降到了约 3.1 美元——同样的处理量，模型换了一轮，成本又下了一个台阶。
...
在我们这支 20 多人的云迁移与云灾备产品团队中，用 OpenAI 模型那段时间，AI-My-Chats 每个月处理的问题、需求和知识记录超过 100 条，模型成本大约只有 5 美元，折合人民币不过三四十元。

{{< figure src="/images/why-we-built-ai-my-chats/azure-cost-overview.webp" alt="Azure 月度成本总览：2025 年 8 月至 2026 年 7 月按月拆分，总计 70.54 美元" caption="同一份账单：按月拆分后，成本曲线比累计数字更直观" >}}
